...
>(  (
    ...
    const [isAnimating, setIsAnimating] = React.useState(false);    // Use controlled value if provided, otherwise use internal state
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto relative z-10",
              className
            )}
        ...
        >
          <Command>
            ...
            <CommandList>
              ...
              <CommandSeparator />
              <CommandGroup>                <div className="flex items-center justify-between">
                  {currentSelectedValues.length > 0 && (
                    <>
                      <CommandItem
