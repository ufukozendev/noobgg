...
export const CountryModal = React.memo(({ country, onClose }: CountryModalProps) => {
  return (
    <div
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <div
                  ...
                  style={{ backgroundColor: country.color, boxShadow: `0 0 8px ${country.color}` }}
                ></div>
                <span className="text-sm text-gray-300">{country.continent}</span>
              </div>
            </div>
          </div>
          <button
